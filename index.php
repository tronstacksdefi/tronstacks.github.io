...
<!--<body>-->
<body onload=" totalcontractdeposit(); getcontractbalance(); totalplayers(); PlayerWithdraw(); PlayerDeposited(); DepositsCount();">
      ...
      <div class="modal-body text-center">
        ...
        <div class="text-left">
          ...
          <ul class="list-group list-group-flush text-left mt-4 bg-gray text-dark">
            <li class="list-group-item bg-gray"><small><i class="fas fa-check-circle text-primary"></i> Minimal deposit amount: 100 TRX (no maximal limits)</small></li>
...
document.getElementById('link-s').value = ('https://tronstacksdefi.github.io/?ref=' + addr);
...
async function DepositsCount(){
	let contract = await window.tronWeb.contract().at(address);
	let playeraddress = textEllipsis(window.tronWeb.defaultAddress.base58);
	let res = await contract.getPlayerNumberOfDeposits(playeraddress).call();
	document.getElementById("no_of_deposit").innerHTML = res;
}
